...
namespace Microsoft.Zelig.Configuration.Environment.Abstractions.Architectures
{
    ...
    public sealed partial class ArmV7 : ArmPlatform
    {
        ...
        public ArmV7( ) : base( c_ProcessorCapabilities ) // Default constructor required by TypeSystemSerializer.
        {
        }

        public ArmV7( ZeligIR.TypeSystemForCodeTransformation typeSystem ,
        ...
        {
            return m_typeSystem.GetWellKnownType( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapper" );
        }
