...
{
    using EncDef = Microsoft.Zelig.TargetModel.ArmProcessor.EncodingDefinition_VFP_ARMv5;

    public class InstructionSetARMv5_VFP : InstructionSetARMv4
    {
        private static EncodingDefinition_VFP s_EncodingVFP = (EncodingDefinition_VFP_ARMv5)CurrentInstructionSetEncoding.GetVFPEncoding();
