...
namespace Microsoft.DeviceModels.Win32
{
    ...
    public class InterruptController
    {
        ...
        public class Handler
        {
            ...
            private Handler(int index, InterruptPriority priority, InterruptSettings settings, Callback callback)
            {
                m_index = index;
                m_priority = priority;
                m_settings = settings;
            ...
            public static Handler Create(int index, InterruptPriority priority, InterruptSettings settings, Callback callback)
            {
