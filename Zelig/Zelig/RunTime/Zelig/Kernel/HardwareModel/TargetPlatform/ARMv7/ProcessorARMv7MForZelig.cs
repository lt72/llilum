...
namespace Microsoft.Zelig.Runtime.TargetPlatform.ARMv7
{
    ...
    public abstract partial class ProcessorARMv7MForZelig : ProcessorARMv7M
    {
        ...
        {
            [TS.WellKnownMethod( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapperHelpers_ScratchedRegisters" )]
            public static extern uint ScratchedRegisters();

            [TS.WellKnownMethod( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapperHelpers_PushRegisters" )]
            public static extern void PushRegisters( uint indexRegister           ,
                                                     bool fWriteBackIndexRegister ,
                                                     bool fAddComputedRegisters   ,
                                                     uint registerMask            );

            [TS.WellKnownMethod( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapperHelpers_PopRegisters" )]
            ...
            [TS.WellKnownMethod( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapperHelpers_PushStackFrame" )]
            public static extern void PushStackFrame();

            [TS.WellKnownMethod( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapperHelpers_PopStackFrame" )]
            public static extern void PopStackFrame();

            [Inline]
            public static void AdjustLinkAddress( uint offset )
            {
                ProcessorARMv7MForZelig.SetRegister( EncDef.c_register_lr, AddressMath.Decrement( ProcessorARMv7MForZelig.GetRegister( EncDef.c_register_lr ), offset ) );
            }

            [Inline]
            public static void PushStackPointer( uint offset )
            {
                ProcessorARMv7MForZelig.SetRegister( EncDef.c_register_sp, AddressMath.Decrement( ProcessorARMv7MForZelig.GetRegister( EncDef.c_register_sp ), offset ) );
            }

            [Inline]
            public static void PopStackPointer( uint offset )
            {
                ProcessorARMv7MForZelig.SetRegister( EncDef.c_register_sp, AddressMath.Increment( ProcessorARMv7MForZelig.GetRegister( EncDef.c_register_sp ), offset ) );
            }
        }

        [TS.WellKnownType( "Microsoft_Zelig_ProcessorARMv7M_MethodWrapper" )]
        ...
        [TS.WellKnownMethod( "ProcessorARMv7M_SetRegister" )]
        public static extern void SetRegister( uint    reg   ,
                                               UIntPtr value );

        [TS.WellKnownMethod( "ProcessorARMv7M_GetRegister" )]
        public static extern UIntPtr GetRegister( uint reg );

        [TS.WellKnownMethod( "ProcessorARMv7M_SetSystemRegister" )]
        public static extern void SetSystemRegister( uint reg   ,
                                                     uint value );

        [TS.WellKnownMethod( "ProcessorARMv7M_GetSystemRegister" )]
        public static extern uint GetSystemRegister( uint reg );

        //--//

        [TS.WellKnownMethod( "ProcessorARMv7M_SetStatusRegister" )]
        public static extern void SetStatusRegister( uint fields ,
                                                     uint value  );

        [TS.WellKnownMethod( "ProcessorARMv7M_GetStatusRegister" )]
        public static extern uint GetStatusRegister();

        [TS.WellKnownMethod( "ProcessorARMv7M_SetSavedStatusRegister" )]
        public static extern void SetSavedStatusRegister( uint fields ,
                                                          uint value  );

        [TS.WellKnownMethod( "ProcessorARMv7M_GetSavedStatusRegister" )]
        public static extern uint GetSavedStatusRegister();

        //--//

        [TS.WellKnownMethod( "ProcessorARMv7M_MoveToCoprocessor" )]
        ...
        [TS.WellKnownMethod( "ProcessorARMv7M_MoveFromCoprocessor" )]
